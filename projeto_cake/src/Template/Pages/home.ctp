<div class="row justify-content-center">
  <div class="align-self-center mr-3 ">
    ...
    -->
    <center>
      <img src="img/logo.png" title="infosus" alt="Generic placeholder image" class="mx-auto d-block" style="width:65%">
    </center>
    <!--             </div>
    -->
  </div>
          ...
          <div class="input-group mb-3">
            <?php if (isset($_GET['search'])): ?>
              ...
              <div class="input-group-append">
                <button class="btn btn-outline-secondary" title="Clique aqui para pesquisar"  type="submit" title="Pesquisar">Pesquisar</button>
              </div>
            ...
            <?php else: ?>
              ...
              <div class="input-group-append">
              <button class="btn btn-outline-secondary" title="Clique aqui para pesquisar" style="background-color: #6c757d;" type="submit">Pesquisar</button>
              </div>
            <?php endif ?>
          </div>
        </form>
